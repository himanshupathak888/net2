...
public class BaseSetup {
	...
	public void Login() throws InterruptedException {
		driver.findElement(By.xpath("//input[contains(@class, 'login-username')]")).sendKeys(prop.getProperty("email"));
		driver.findElement(By.xpath("//input[contains(@class, 'login-password')]"))
